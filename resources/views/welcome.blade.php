...
@section('content')
         ...
         <section class="container mt-5">
            ...
            <div class="row margin-y g-5">
                <div class="col-lg-4 col-md-4 col-sm-12 d-flex justify-content-center">
                    <img style=" filter: grayscale(100%);" width="288" height="243" src="images/feature-bike.jpg"
                    alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 d-flex justify-content-center">
                    <img width="288" height="243" src="images/feature-bike.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 d-flex justify-content-center">
                    <img style=" filter: grayscale(100%);" width="288" height="243" src="images/feature-bike.jpg"
                    alt="">
        ...
        <!-- Latest News Section -->
         <section class="container lw-section" id="news mb-2">
            ...
            <div class="row mt-3 g-5">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 d-flex justify-content-center">
                    <div class="card" style="width: 18rem;">
                        <img class="m-2" src="images/bike-2.png" class="card-img-top" alt="...">
                        <div class="card-body m-0">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 d-flex justify-content-center">
                    <div class="card" style="width: 18rem;">
                        <img class="m-2" src="images/bike-3.png" class="card-img-top" alt="...">
                        <div class="card-body m-0">
        ...
        <!-- Top-Seller -->
        <Section class=" container top-seller">
            <h2 class="fw-bold text-center">Top <span class="dark-orange">Sellers</span></h2>
